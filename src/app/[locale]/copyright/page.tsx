...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - GameOverse Wiki',
    description: 'Copyright and intellectual property information for GameOverse Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - GameOverse Wiki',
      description: 'Copyright and intellectual property information for GameOverse Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 GameOverse Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of GameOverse Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              GameOverse Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>YouTube</strong> - Owner of the YouTube platform</li>
              <li><strong>GameOverse Developers</strong> - Creators of the GameOverse game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>GameOverse</strong> - Trademark of the game developers</li>
              <li><strong>GameOverse Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with GameOverse Wiki.
            </p>
            ...
            <p>
              ...
              GameOverse Wiki<br />
              Email: <a href="mailto:dmca@gameoverse.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gameoverse.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "GameOverse Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: GameOverse Wiki (gameoverse.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gameoverse.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gameoverse.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gameoverse.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gameoverse.wiki</a>
            </p>
            <p>
