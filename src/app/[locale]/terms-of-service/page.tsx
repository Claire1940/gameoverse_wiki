...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - GameOverse Wiki",
    description: "Read the Terms of Service for GameOverse Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our GameOverse animated series resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - GameOverse Wiki",
      description: "Terms and conditions for using GameOverse Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using GameOverse Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using GameOverse Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and GameOverse Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              GameOverse Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the GameOverse animated series "GameOverse". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> GameOverse Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (GLITCH Productions) or the official developers of GameOverse. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by GameOverse Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (GLITCH Productions) and/or the developers of GameOverse. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> YouTube demo availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including YouTube, Discord, social media platforms,
            ...
            <p>
              ...
              you and GameOverse Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@gameoverse.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@gameoverse.wiki</a>
            </p>
            <p>
