...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.gameoverse.wiki";
    ...
    "@graph": [
      {
        ...
        "@id": `${siteUrl}/#website`,
        url: siteUrl,
        name: "GameOverse Wiki",
        description:
          "Complete GameOverse Wiki covering characters, episodes, cast, lore, villains, worlds, and official links for the GLITCH animated series.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "GameOverse Wiki Hero Image",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "GameOverse Wiki",
        alternateName: "GameOverse",
        url: siteUrl,
        description:
          "Fan resource hub for GameOverse characters, episodes, cast, lore, and world guides.",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "GameOverse Wiki - Surreal Voxel Survival Sandbox",
        },
        sameAs: [
          "https://www.glitchprod.com/gameoverse",
          "https://www.glitchinn.com",
          "https://x.com/Gameoverse",
      ...
      },
      {
        ...
        url: "https://www.glitchprod.com/gameoverse",
        sameAs: ["https://www.youtube.com/@GLITCH"],
      },
      {
        "@type": "VideoObject",
        name: "GAMEOVERSE [TRAILER]",
        description:
          "Official GameOverse trailer by GLITCH Productions.",
        uploadDate: "2026-01-24",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/V2Gx9icNQiA",
        url: "https://www.youtube.com/watch?v=V2Gx9icNQiA",
      },
    ],
  };
  ...
  return (
    <div className="home-shell min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              <button
                onClick={() => scrollToSection("release-date-watch-guide")}
              ...
              <a
                href="https://www.glitchprod.com/gameoverse"
                target="_blank"
      ...
      <section id="release-date-watch-guide" className="scroll-mt-24 px-4 py-14 md:py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-8 md:mb-12 scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseReleaseDateWatchGuide"]}
                locale={locale}
              >
                {t.modules.gameOverseReleaseDateWatchGuide.title}
              </LinkedTitle>
            </h2>
            <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
              {t.modules.gameOverseReleaseDateWatchGuide.intro}
            </p>
          </div>

          {/* Steps */}
          <div className="scroll-reveal space-y-3 md:space-y-4 mb-8 md:mb-10">
            {t.modules.gameOverseReleaseDateWatchGuide.steps.map(
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl font-bold mb-1.5 md:mb-2">
                      <LinkedTitle
                        linkData={
                          moduleLinkMap[
                            `gameOverseReleaseDateWatchGuide::steps::${index}`
                          ]
                        }
                        locale={locale}
                      >
          ...
          <div className="scroll-reveal p-4 md:p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            ...
            <ul className="space-y-2">
              {t.modules.gameOverseReleaseDateWatchGuide.quickTips.map(
      ...
      <section id="episodes-guide" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseEpisodesGuide"]}
                locale={locale}
              >
                {t.modules.gameOverseEpisodesGuide.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.gameOverseEpisodesGuide.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {t.modules.gameOverseEpisodesGuide.cards.map(
                ...
                >
                  <h3 className="font-bold text-lg mb-2 text-[hsl(var(--nav-theme-light))]">
                    <LinkedTitle
                      linkData={
                        moduleLinkMap[
                          `gameOverseEpisodesGuide::cards::${index}`
                        ]
                      }
                      locale={locale}
                    >
          ...
          <div className="scroll-reveal flex flex-wrap gap-3 justify-center">
            {t.modules.gameOverseEpisodesGuide.milestones.map(
              (m: string, i: number) => (
                <span
                  key={i}
      ...
      <section id="characters-voice-cast" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseCharactersAndVoiceCast"]}
                locale={locale}
              >
                {t.modules.gameOverseCharactersAndVoiceCast.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.gameOverseCharactersAndVoiceCast.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t.modules.gameOverseCharactersAndVoiceCast.items.map(
                ...
                >
                  ...
                  <h3 className="font-bold mb-2">
                    <LinkedTitle
                      linkData={
                        moduleLinkMap[
                          `gameOverseCharactersAndVoiceCast::items::${index}`
                        ]
                      }
                      locale={locale}
                    >
      ...
      <section id="story-premise" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseStoryAndPremiseExplained"]}
                locale={locale}
              >
                {t.modules.gameOverseStoryAndPremiseExplained.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.gameOverseStoryAndPremiseExplained.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {t.modules.gameOverseStoryAndPremiseExplained.solutions.map(
              (s: any, index: number) => (
                <div
                  key={index}
                  className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <h3 className="font-bold">
                      <LinkedTitle
                        linkData={
                          moduleLinkMap[
                            `gameOverseStoryAndPremiseExplained::solutions::${index}`
                          ]
                        }
                        locale={locale}
                      >
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.05)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            ...
            <ul className="space-y-2">
              {t.modules.gameOverseStoryAndPremiseExplained.managementTips.map(
                (tip: string, i: number) => (
      ...
      <section id="ending-lore" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseEndingAndLoreExplained"]}
                locale={locale}
              >
                {t.modules.gameOverseEndingAndLoreExplained.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
      ...
      <section id="trailer-breakdown" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseTrailerBreakdown"]}
                locale={locale}
              >
                {t.modules.gameOverseTrailerBreakdown.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
      ...
      <section id="original-reboot-guide" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseOriginalSeriesAndRebootGuide"]}
                locale={locale}
              >
                {t.modules.gameOverseOriginalSeriesAndRebootGuide.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
      ...
      <section id="season-status" className="scroll-mt-24 px-4 py-20">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-12 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <LinkedTitle
                linkData={moduleLinkMap["gameOverseSeasonOneAndEpisodeTwoStatus"]}
                locale={locale}
              >
                {t.modules.gameOverseSeasonOneAndEpisodeTwoStatus.title}
              </LinkedTitle>
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              {t.modules.gameOverseSeasonOneAndEpisodeTwoStatus.intro}
            </p>
          </div>
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {t.modules.gameOverseSeasonOneAndEpisodeTwoStatus.items.map(
              (item: any, index: number) => (
                <div
                  key={index}
                  className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors"
                >
                  ...
                  <h3 className="font-bold mb-2">
                    <LinkedTitle
                      linkData={
                        moduleLinkMap[
                          `gameOverseSeasonOneAndEpisodeTwoStatus::items::${index}`
                        ]
                      }
                      locale={locale}
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://www.youtube.com/@GLITCH"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
